...
#define nstates10	11	/* siempre_los_dos_en_verde */
#define minseq10	247
#define maxseq10	256
#define endstate10	10

#define nstates9	11	/* nunca_los_dos_en_verde */
#define minseq9	237
#define maxseq9	246
#define endstate9	10

#define nstates8	14	/* recurrentemente_greenP */
#define minseq8	224
#define maxseq8	236
#define endstate8	13

#define nstates7	14	/* espiraS_implica_greenS */
#define minseq7	211
#define maxseq7	223
#define endstate7	13

#define nstates6	41	/* secuencia_semaforoS */
#define minseq6	171
#define maxseq6	210
#define endstate6	40

#define nstates5	41	/* secuencia_semaforoP */
#define minseq5	131
#define maxseq5	170
#define endstate5	40

#define nstates4	23	/* peatonS_cruza */
#define minseq4	109
#define maxseq4	130
#define endstate4	22

#define nstates3	23	/* peatonP_cruza */
#define minseq3	87
#define maxseq3	108
#define endstate3	22

#define nstates2	11	/* siempre_redP_o_redS */
#define minseq2	77
#define maxseq2	86
#define endstate2	10

#define nstates1	15	/* entorno */
#define minseq1	63
#define maxseq1	76
#define endstate1	14

#define nstates0	64	/* fsm */
#define minseq0	0
#define maxseq0	62
#define endstate0	63
...
typedef struct P10 { /* siempre_los_dos_en_verde */
...
typedef struct P9 { /* nunca_los_dos_en_verde */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P8 { /* recurrentemente_greenP */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* espiraS_implica_greenS */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P6 { /* secuencia_semaforoS */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* secuencia_semaforoP */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P2 { /* siempre_redP_o_redS */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, estado) - 1*sizeof(int))
...
#define _NP_	11
#define nstates11	3 /* np_ */
#define endstate11	2 /* np_ */

#define start11	0 /* np_ */
#define start10	6
#define start9	6
#define start8	5
#define start7	5
...
#else
	#define ACCEPT_LAB	15 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
